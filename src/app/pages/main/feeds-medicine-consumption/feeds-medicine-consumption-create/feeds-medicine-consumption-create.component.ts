    ...
    await this.feedsandmedicineConsumption.getList(this.order, this.house_id).then((res: any) => {
      ...
      if (res.error == 0) {
        if (res.data) {
          ...
          console.log('houseData', this.house_data);
          ...
          this.medicineConsumptionForm.controls.age_week.setValue(res.house_details.current_age_of_chicken ? res.house_details.current_age_of_chicken.age_week : 1 );
          this.medicineConsumptionForm.controls.age_day.setValue(res.house_details.current_age_of_chicken ? res.house_details.current_age_of_chicken.age_day : 0 );
